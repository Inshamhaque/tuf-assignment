...
export const Addflashcard = ({ onClose }: { onClose: () => void }) => {
    ...
    const onClickHandler = async () => {
        setLoading(true);
        try {
            await axios.post(`https://backend-final-2-2jx8.onrender.com/api/admin/flashcard/${topic}`, {
                question,
                answer
            });
    ...
    return (
        <div className="backdrop-blur fixed inset-0 z-50 flex items-center justify-center w-full h-full bg-black bg-opacity-20">
